...
public class RadioBOConverterImpl implements RadioBOConverter {

    @Override
    public SubjectRadio ConvertBO2PO(SubjectAnswerBO subjectAnswerBO) {
    ...
    @Override
    public List<SubjectAnswerBO> ConvertPOList2BOList(List<SubjectRadio> subjectRadioList) {
